...
export type ExitReason =
  ...
  | 'no_market_data'
  /** Χειροκίνητη πώληση μετά από αποτυχημένη αυτόματη προσπάθεια (needs_manual_exit) —
   * ρητή απόφαση χρήστη 2026-09-15, βλ. scripts/close-manual-exit.ts. Δεν ξέρουμε πια
   * ΓΙΑΤΙ ήθελε αρχικά να βγει το σύστημα (tier/trailing/stop_loss/exit_signal) — αυτή
   * η πληροφορία χάνεται στο σημείο της αποτυχίας, δεν αποθηκεύεται πουθενά ρητά. */
  | 'manual';
